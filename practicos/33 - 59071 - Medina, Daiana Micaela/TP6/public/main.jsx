function App() {
    ...
    return (
        <div className="contenedor-formularios">
            <h1 className="h1-tp6">¡Bienvenido al inicio de gestion!</h1>
            ...
            {!estadoSesion ? (
                <div className="contenedor-formularios-seccion-dos">
                    ...
                    <div className="info-usuario-logeado">
                        <p className="p-info-usuario-logeado">Tienes que iniciar sesión  para poder ver la información.</p>
                    </div>
                </div>
            ) : (
                <div className="contenedor-formularios-seccion-dos">
                    ...
                    <div className="contenedor-botones-usuario-logeado">
                        <button className="btn-ver-info" onClick={obtenerInfoUsuario}>Ver informacion</button>
